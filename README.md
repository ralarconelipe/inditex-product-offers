...
INSERT INTO OFFER (BRAND_ID, START_DATE, END_DATE, PRICE_LIST, PART_NUMBER, PRIORITY, PRICE, CURR)
VALUES (1, '2020-06-14T00:00:00Z', '2020-12-31T23:59:59Z', 1, '0001002', 0, 35.50, 'EUR');
```
...
This project uses **JaCoCo** (Java Code Coverage) to measure test coverage. JaCoCo generates detailed reports that help identify untested parts of the codebase.
